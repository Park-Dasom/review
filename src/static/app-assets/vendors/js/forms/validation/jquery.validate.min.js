  ...
  a.extend(a.expr.pseudos || a.expr[":"], {
    ...
    a.extend(a.validator, {
      ...
      messages: {
        ...
        maxlength: a.validator.format("{0}자 이내로 입력하세요."),
        minlength: a.validator.format("{0}자 이상을 입력하세요."),
        rangelength: a.validator.format("{0}자에서 {1}자 사이의 값을 입력하세요."),
        range: a.validator.format("{0}에서 {1} 사이의 값을 입력하세요."),
        max: a.validator.format("{0}보다 작거나 같은 값을 입력하세요."),
        min: a.validator.format("{0}보다 작거나 같은 값을 입력하세요."),
        step: a.validator.format("{0}의 배수를 입력하세요."),
      },
      autoCreateRanges: !1,
      prototype: {
        init: function () {
